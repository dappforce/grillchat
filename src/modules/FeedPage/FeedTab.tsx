...
import useGetFeedPostIds from '@/components/chats/hooks/useGetFeedPosts'
...
const FeedTab = ({ scrollContainerRef: _scrollContainerRef }: Props) => {
  ...
  const {
    ...
    loadMore,
    totalDataCount,
  } = useGetFeedPostIds({ address: myAddress || '' })
