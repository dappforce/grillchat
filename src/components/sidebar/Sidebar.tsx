...
export default function Sidebar({ isShowFull }: sidebarprops) {
  return (
    <div
      className={`${!isShowFull && 'xs:hidden  md:block'}  z-10    md:w-24 `}
    >
      <div
        className={`${
          isShowFull && 'fixed top-[50px] h-screen w-screen bg-black/30'
        }`}
      >
        <div
          className={`${
            isShowFull ? 'w-52 bg-white/90 p-2 dark:bg-black' : 'items-center'
